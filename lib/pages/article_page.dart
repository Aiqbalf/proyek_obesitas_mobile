                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _green700, foregroundColor: Colors.white,
...
class _ArticleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final imageUrl = (item['gambar'] != null &&
        ...
        : 'https://picsum.photos/seed/${item['_id'] ?? item['id'] ?? '1'}/600/300';
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                errorBuilder: (_, __, ___) => Container(
                  height: 180,
                  decoration: const BoxDecoration(color: _green50),
                  child: const Center(
                    child: Icon(Icons.image_not_supported_rounded,
                        color: _green100, size: 48),
                  ),
                ),
                  ...
                  if (item['ringkasan'] != null &&
                    ...
                    Text(
                      ...
                      style: const TextStyle(fontSize: 13,
                          color: _neutral400, height: 1.5),
                    ),

                  const SizedBox(height: 14),

                  // ── Footer: penulis + tombol ──
                  Row(
                    children: [
                      if (item['penulis'] != null) ...[
                        const Icon(Icons.person_outline_rounded,
                            size: 14, color: _neutral400),
                        const SizedBox(width: 4),
                        Text(item['penulis'].toString(),
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                ...
                children: [
                  ...
                  // Gradient overlay agar teks AppBar terbaca
                  Container(
                    decoration: BoxDecoration(
                ...
                children: [
                  ...
                  if (article['kategori'] != null)
                    Container(
                      ...
                      child: Text(article['kategori'].toString(),
                        style: const TextStyle(fontSize: 12,
                            fontWeight: FontWeight.w700, color: _green700)),
                    ),
                  ...
                  Text(article['judul'] ?? '',
                    style: const TextStyle(fontSize: 24,
                        fontWeight: FontWeight.w900, color: _neutral900,
                  ...
                  Row(children: [
                    const Icon(Icons.person_outline_rounded,
                        size: 15, color: _neutral400),
                    const SizedBox(width: 6),
                    Text(article['penulis'] ?? 'Admin',
                      style: const TextStyle(fontSize: 13, color: _neutral400)),
                  ]),

                  const SizedBox(height: 16),
                  const Divider(color: _neutral200),
                  const SizedBox(height: 16),

                  // Isi artikel
                  Text(article['isi'] ?? '',
                    style: const TextStyle(fontSize: 15,
                        color: _neutral600, height: 1.8)),
